...
ASEMeshes::ASEMesh::ASEMesh(const char* _fileName)
{
...
String^ ASEMeshes::ASEMesh::ExtractValue(cli::array<String^>^ _lines, String^ _tag, int& _lineFound)
{
...
void ASEMeshes::ASEMesh::ParseMaps(cli::array<String^>^ _maps, Material^ _material)
{
...
void ASEMeshes::ASEMesh::ExtractVectorList(List<Vec3^>^ _list, String^ _tag, cli::array<String^>^ _lines, int& _lineFound)
{
	String^ info;
...
void ASEMeshes::ASEMesh::ParseGeoObjects(cli::array<String^>^ _geoObjects)
{
...
void ASEMeshes::ASEMesh::ParseMaterials(cli::array<String^>^ _materials)
{
...
Vec3^ ASEMeshes::ASEMesh::ParseStringToVec3(String^ _vectorS)
{
